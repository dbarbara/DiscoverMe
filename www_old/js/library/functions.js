        ...
        if ("geolocation" in navigator) {
            ...
            watchID = navigator.geolocation.watchPosition(
                                                            ...
                                                            function onSuccess(data) {
                                                                ...
                                                                var coordinates = {"lat":data.coords.latitude,"long":data.coords.longitude};

                                                                var localData = JSON.stringify(coordinates);
                                                                window.localStorage.removeItem("geolocation");
                                                                window.localStorage.setItem("geolocation", localData);
                                                            },
